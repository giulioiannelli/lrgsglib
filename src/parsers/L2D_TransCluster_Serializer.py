...
from lrgsglib.config.progargs import (
    ...
    L2D_TransCluster_progName,
    L2D_TransCluster_progNameShrt,
    srun_action_args,
    L2D_TransCluster_args,
...
parser = argparse.ArgumentParser(
    description=L2D_TransCluster_srun_description,
...
parser.add_argument(
    ...
    inner_prog_name=L2D_TransCluster_progName,
    inner_positional_args=L2D_TransCluster_args,
...
# be passed directly to L2D_TransCluster.py via *unknown args, where they will be
# properly parsed by the underlying program's parser.

for key, opts in {**L2D_TransCluster_srun_optional_args_dict, **srun_action_args}.items():
