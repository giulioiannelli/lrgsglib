...
phelp_data_save_freq = "Save every N averages (checkpoint frequency)"
phelp_eigMode = "Eigenvector selection mode: 'smallest', 'largest', or 'middle'"
phelp_exc = "Option to execute the output of the Serializer"
...
phelp_print = "Option to print the output of the Serializer"
...
phelp_gputype = "GPU type selection (auto-used when backend=cupy): 'a100', 'fermi', or 'fermi:2' (both C2050 cards)"
phelp_partition = "Slurm partition selection: 'AMD' for high-memory jobs (auto-selected for >100GB), None for default partition"
