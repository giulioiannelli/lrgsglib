...
LRGSG_STATSYS_ISING: Path = _env(
    "LRGSG_STATSYS_ISING", _model_ccore("IsingDynamics")
)
LRGSG_STATSYS_ISING_BIN: Path = _env(
    "LRGSG_STATSYS_ISING_BIN", LRGSG_STATSYS_ISING / "bin"
)
LRGSG_STATSYS_CP: Path = _env(
    "LRGSG_STATSYS_CP", _model_ccore("ContactProcess")
)
LRGSG_STATSYS_CP_BIN: Path = _env(
    "LRGSG_STATSYS_CP_BIN", LRGSG_STATSYS_CP / "bin"
)
LRGSG_STATSYS_VM: Path = _env("LRGSG_STATSYS_VM", _model_ccore("VoterModel"))
LRGSG_STATSYS_VM_BIN: Path = _env(
    "LRGSG_STATSYS_VM_BIN", LRGSG_STATSYS_VM / "bin"
)
LRGSG_STATSYS_SRW: Path = _env("LRGSG_STATSYS_SRW", _model_ccore("SignedRW"))
LRGSG_STATSYS_KUR: Path = _env(
    "LRGSG_STATSYS_KUR", _model_ccore("KuramotoModel")
)
LRGSG_STATSYS_KUR_BIN: Path = _env(
    "LRGSG_STATSYS_KUR_BIN", LRGSG_STATSYS_KUR / "bin"
)
LRGSG_STATSYS_RD: Path = _env(
    "LRGSG_STATSYS_RD", _model_ccore("ReactionDiffusionModel")
)
LRGSG_STATSYS_RD_BIN: Path = _env(
    "LRGSG_STATSYS_RD_BIN", LRGSG_STATSYS_RD / "bin"
)
LRGSG_STATSYS_CODE: Path = _env(
    "LRGSG_STATSYS_CODE", _model_ccore("CoupledODEModel")
)
LRGSG_STATSYS_CODE_BIN: Path = _env(
    "LRGSG_STATSYS_CODE_BIN", LRGSG_STATSYS_CODE / "bin"
)
LRGSG_STATSYS_POTTS: Path = _env(
    "LRGSG_STATSYS_POTTS", _model_ccore("PottsModel")
)
LRGSG_STATSYS_POTTS_BIN: Path = _env(
    "LRGSG_STATSYS_POTTS_BIN", LRGSG_STATSYS_POTTS / "bin"
)
LRGSG_STATSYS_XY: Path = _env("LRGSG_STATSYS_XY", _model_ccore("XYModel"))
LRGSG_STATSYS_XY_BIN: Path = _env(
    "LRGSG_STATSYS_XY_BIN", LRGSG_STATSYS_XY / "bin"
)
LRGSG_STATSYS_HBERG: Path = _env(
    "LRGSG_STATSYS_HBERG", _model_ccore("HeisenbergModel")
)
LRGSG_STATSYS_HBERG_BIN: Path = _env(
    "LRGSG_STATSYS_HBERG_BIN", LRGSG_STATSYS_HBERG / "bin"
)
LRGSG_STATSYS_MSPEC: Path = _env(
    "LRGSG_STATSYS_MSPEC", _model_ccore("MultiSpeciesModel")
)
LRGSG_STATSYS_MSPEC_BIN: Path = _env(
    "LRGSG_STATSYS_MSPEC_BIN", LRGSG_STATSYS_MSPEC / "bin"
)

# --- Ising (RBIM) C++ subtrees & SignedRW lattices ---------------------------
LRGSG_RBIM_BASE: Path = _env("LRGSG_RBIM_BASE", LRGSG_STATSYS_ISING / "base")
LRGSG_RBIM_STORE: Path = _env(
    "LRGSG_RBIM_STORE", LRGSG_STATSYS_ISING / "storer"
)
LRGSG_RBIM_NATIVE: Path = _env(
    "LRGSG_RBIM_NATIVE", LRGSG_STATSYS_ISING / "native"
)
...
LRGSG_GRAPHS_GT_L2D_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_L2D_CPP", LRGSG_GRAPHS_GT_L2D / "cpp"
)
LRGSG_GRAPHS_GT_BA: Path = _env("LRGSG_GRAPHS_GT_BA", _GT / "BarabasiAlbertGT")
LRGSG_GRAPHS_GT_BA_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_BA_CPP", LRGSG_GRAPHS_GT_BA / "cpp"
)
LRGSG_GRAPHS_GT_EBA: Path = _env(
    "LRGSG_GRAPHS_GT_EBA", _GT / "ExtendedBarabasiAlbertGT"
)
LRGSG_GRAPHS_GT_EBA_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_EBA_CPP", LRGSG_GRAPHS_GT_EBA / "cpp"
)
LRGSG_GRAPHS_GT_DBA: Path = _env(
    "LRGSG_GRAPHS_GT_DBA", _GT / "DualBarabasiAlbertGT"
)
LRGSG_GRAPHS_GT_DBA_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_DBA_CPP", LRGSG_GRAPHS_GT_DBA / "cpp"
)
LRGSG_GRAPHS_GT_FC: Path = _env("LRGSG_GRAPHS_GT_FC", _GT / "FullyConnectedGT")
LRGSG_GRAPHS_GT_FC_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_FC_CPP", LRGSG_GRAPHS_GT_FC / "cpp"
)
LRGSG_GRAPHS_GT_HK: Path = _env("LRGSG_GRAPHS_GT_HK", _GT / "HolmeKimGT")
LRGSG_GRAPHS_GT_HK_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_HK_CPP", LRGSG_GRAPHS_GT_HK / "cpp"
)
LRGSG_GRAPHS_GT_MC: Path = _env(
    "LRGSG_GRAPHS_GT_MC", _GT / "MultiplicativeCascadeGT"
)
LRGSG_GRAPHS_GT_MC_CPP: Path = _env(
    "LRGSG_GRAPHS_GT_MC_CPP", LRGSG_GRAPHS_GT_MC / "cpp"
)
