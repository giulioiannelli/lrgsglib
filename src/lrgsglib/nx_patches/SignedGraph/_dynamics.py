...
def compute_rbim_energy_eigV(self: "SignedGraph", which: int = 0, use_gpu: bool = False, on_g: str = SG_REPR):
...
def compute_sksph_energy_eigV(self: "SignedGraph", which: int = 0, use_gpu: bool = False, on_g: str = SG_REPR):
...
def compute_sksph_energy_eigV_all(self: "SignedGraph", on_g: str = SG_REPR, **kw_laplspect):
...
def get_sksph_energy_eigV(self: "SignedGraph", which: int = 0):
...
def get_all_sksph_energy_eigV(self: "SignedGraph", as_dict: bool = False, on_g: str = SG_REPR, **kw_laplspect):
...
def compute_rbim_energy_eigV_all(self: "SignedGraph", on_g: str = SG_REPR, **kw_laplspect):
    if not hasattr(self, "eigV"):
        compute_laplacian_spectrum_weigV(self, **kw_laplspect)
    if not hasattr(self, "energy_eigV_RBIM"):
        self.energy_eigV_RBIM = {}
...
def get_rbim_energy_eigV(self: "SignedGraph", which: int = 0):
...
def get_all_rbim_energy_eigV(self: "SignedGraph", as_dict: bool = False, on_g: str = SG_REPR, **kw_laplspect):
    if not hasattr(self, "energy_eigV_RBIM"):
