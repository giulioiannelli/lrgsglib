"""
BipartiteGraph: Signed bipartite (two-mode) network.
...
>>> bg = BipartiteGraph(n1=20, n2=30, p=0.1, pflip=0.1, seed=42)
...
class BipartiteGraph(SignedGraph):
    """
    ...
    **kwargs : Any
    ...
    >>> bg = BipartiteGraph(n1=50, n2=100, p=0.05, seed=42)
...
class BipartiteFromDegreeSequence(SignedGraph):
    """
    ...
    **kwargs : Any
    ...
    Examples
    --------
    >>> from lrgsglib.nx_patches.bipartite import BipartiteFromDegreeSequence
    >>> # Create bipartite with specified degrees
    >>> top_deg = [3, 3, 2, 2]  # sum = 10
    >>> bot_deg = [2, 2, 2, 2, 2]  # sum = 10
    >>> bg = BipartiteFromDegreeSequence(top_deg, bot_deg, seed=42)
    """
