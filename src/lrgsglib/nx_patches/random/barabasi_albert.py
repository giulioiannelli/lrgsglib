"""
BarabasiAlbert: Scale-free graph via preferential attachment.

This module provides the BarabasiAlbert class for generating scale-free
networks using the Barabasi-Albert preferential attachment model.

Example
-------
>>> from lrgsglib.nx_patches.random import BarabasiAlbert
>>> ba = BarabasiAlbert(n=100, m=3, pflip=0.1, seed=42)
...
class BarabasiAlbert(RandomGraph):
    ...
    **kwargs : Any
    ...
    --------
    >>> from lrgsglib.nx_patches.random import BarabasiAlbert
    >>> ba = BarabasiAlbert(n=500, m=2, pflip=0.15, seed=42)
    >>> ba.flip_random_fract_edges()
