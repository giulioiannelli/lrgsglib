...
PYBIND11_MODULE(random_walker, m) {
    m.doc() = "Random walker on signed lattices";

    py::class_<RandomWalker>(m, "RandomWalker")
        .def(py::init<py::list, py::list, int, int, unsigned int>(),
             py::arg("edge_list"), py::arg("sign_list"),
             py::arg("width"), py::arg("height"),
             py::arg("coordination_number"))
