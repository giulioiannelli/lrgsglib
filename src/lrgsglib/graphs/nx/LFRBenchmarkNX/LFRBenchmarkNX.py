"""
LFRBenchmarkNX: Lancichinetti-Fortunato-Radicchi benchmark graph.
...
Example
-------
>>> from lrgsglib.graphs.nx import LFRBenchmarkNX
>>> lfr = LFRBenchmarkNX(n=250, tau1=3, tau2=1.5, mu=0.1, average_degree=5, seed=42)
...
class LFRBenchmarkNX(RandomGraphNX):
    """
    ...
    **kwargs : Any
    ...
    >>> lfr_hard = LFRBenchmarkNX(n=250, tau1=3, tau2=1.5, mu=0.4, average_degree=5, seed=42)
    """
