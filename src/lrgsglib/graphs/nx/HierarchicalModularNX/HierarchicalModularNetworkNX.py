...
from ....config.const import DEFAULT_P_FSTR_FMT
...
class HierarchicalModularNetworkNX(MultispectralGraphNX):
    ...
    **kwargs
        Additional arguments passed to MultispectralGraphNX/SignedGraphNX.
    ...
    Examples
    --------
    >>> from lrgsglib.graphs.nx.HierarchicalModularNX import HierarchicalModularNetworkNX
    >>> hmn = HierarchicalModularNetworkNX(levels=2, branching=2, leaf_nodes=4)
    ...
    >>> # With frustration
    >>> hmn = HierarchicalModularNetworkNX(levels=2, branching=2, leaf_nodes=4, pflip=0.3)
    ...
    def __repr__(self) -> str:
        return (
            f"HierarchicalModularNetworkNX("
