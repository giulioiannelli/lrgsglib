"""Vicsek (Palla-Lovasz-Vicsek) graph generator."""
...
class VicsekGraphNX(MultispectralGraphNX):
    """Vicsek (Palla-Lovasz-Vicsek) graph via Kronecker product.
    ...
    def __repr__(self) -> str:
        return f"VicsekGraphNX(N={self.N}, k={self.k})"


# Backward compatibility alias
VicsekGraph = VicsekGraphNX
