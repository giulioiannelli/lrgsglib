...
class DiracLatticeGraphNX(MultispectralGraphNX):
    ...
    def __init__(self, periodic: bool = True, **kwargs):
        ...
        **kwargs
            Additional arguments passed to MultispectralGraphNX
        """
    ...
    def is_dirac_structure(self) -> bool:
        """Always True for DiracLatticeGraphNX subclasses."""
        return True


# Attach spectral methods to class
DiracLatticeGraphNX.compute_base_spectrum = _spectral.compute_base_spectrum
DiracLatticeGraphNX.compute_fiber_laplacian = _spectral.compute_fiber_laplacian
...
DiracLatticeGraph = DiracLatticeGraphNX
