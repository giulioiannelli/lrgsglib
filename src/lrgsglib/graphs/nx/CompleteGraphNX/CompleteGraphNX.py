"""
CompleteGraphNX: Abstract base class for fully connected graphs.
...
Example
-------
>>> from lrgsglib.graphs.nx.FullyConnectedNX import FullyConnectedNX
>>> fc = FullyConnectedNX(N=50, pflip=0.1, seed=42)
...
class CompleteGraphNX(SignedGraphNX):
    """
