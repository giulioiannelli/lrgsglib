...
class HofieldNNNX(FullyConnectedNX):
    """
    HofieldNNNX is a Hopfield-like neural network that inherits from FullyConnectedNX.
    It uses the fully connected graph structure from FullyConnectedNX and implements
