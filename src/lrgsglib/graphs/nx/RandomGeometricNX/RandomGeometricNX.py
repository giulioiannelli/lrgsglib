"""
RandomGeometricNX: Random geometric graph with spatial constraints.
...
Example
-------
>>> from lrgsglib.graphs.nx import RandomGeometricNX
>>> rgg = RandomGeometricNX(n=200, radius=0.15, dim=2, pflip=0.1, seed=42)
...
class RandomGeometricNX(RandomGraphNX):
    """
    ...
    **kwargs : Any
    ...
    >>> rgg = RandomGeometricNX(n=n, radius=1.5*r_c, dim=2, seed=42)
