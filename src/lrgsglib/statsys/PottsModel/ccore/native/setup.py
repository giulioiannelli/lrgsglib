"""Build script for the _potts_native pybind11 extension."""
...
CCORE_DIR = HERE.parent                              # PottsModel/ccore
...
LRGSG_ROOT = CCORE_DIR.parents[4]  # ccore -> PottsModel -> statsys -> lrgsglib -> src -> ROOT
...
ext_modules = [
    Pybind11Extension(
        "_potts_native",
        sources=[
            str(CCORE_DIR / "potts_native.cpp"),
            str(CCORE_DIR / "LRGSG_potts.c"),
