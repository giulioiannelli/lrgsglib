...
_gcc15_compat = os.path.join(
    _here, "..", "..", "..", "..", "..", "..", "build", "gcc15_compat.h"
)
...
ext_modules = [
    Extension(
        ...
        extra_compile_args=["-O3", "-include", _gcc15_compat],
        extra_link_args=["-O3"],
        libraries=[
            f"boost_python{get_python_version()}"
        ],  # Dynamically set the Boost.Python library
        language="c++",
    ),
]
