"""Build script for the _rd_native pybind11 extension."""
...
CCORE_DIR = HERE.parent                              # ReactionDiffusionModel/ccore
...
ext_modules = [
    Pybind11Extension(
        "_rd_native",
        sources=[
            str(CCORE_DIR / "rd_native.cpp"),
            str(CCORE_DIR / "LRGSG_rd.c"),
...
setup(name="_rd_native", ext_modules=ext_modules,
