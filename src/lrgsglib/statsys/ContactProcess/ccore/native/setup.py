"""Build script for the _cp_native pybind11 extension."""
...
CCORE_DIR = HERE.parent  # ContactProcess/ccore
...
LRGSG_ROOT = CCORE_DIR.parents[
    4
]  # ccore -> ContactProcess -> statsys -> lrgsglib -> src -> ROOT
...
ext_modules = [
    Pybind11Extension(
        "_cp_native",
        sources=[
            str(CCORE_DIR / "cp_native.cpp"),
            str(CCORE_DIR / "LRGSG_cp.c"),
