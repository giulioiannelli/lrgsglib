"""Build script for the _voter_native pybind11 extension."""
...
CCORE_DIR = HERE.parent                              # VoterModel/ccore
...
LRGSG_ROOT = CCORE_DIR.parents[4]  # ccore -> VoterModel -> statsys -> lrgsglib -> src -> ROOT
...
ext_modules = [
    Pybind11Extension(
        ...
        sources=[
            ...
            str(SHARED_CCORE / "LRGSG_clusters.c"),
