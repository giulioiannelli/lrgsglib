"""Build script for the _code_native pybind11 extension."""
...
CCORE_DIR = HERE.parent                              # CoupledODEModel/ccore
...
ext_modules = [
    Pybind11Extension(
        "_code_native",
        sources=[
            str(CCORE_DIR / "code_native.cpp"),
            str(CCORE_DIR / "LRGSG_code.c"),
...
setup(name="_code_native", ext_modules=ext_modules,
